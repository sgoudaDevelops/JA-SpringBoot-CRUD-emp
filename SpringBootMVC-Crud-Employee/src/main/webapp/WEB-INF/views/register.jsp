...
Projects : <form:checkbox path="empPrjs" value="Local" /> Local <form:checkbox
				path="empPrjs" value="Outside" /> Outside 
...
<c:choose>
	...
	<a href="/SpringBootMVC-Crud-Employee/all">Show All</a>
